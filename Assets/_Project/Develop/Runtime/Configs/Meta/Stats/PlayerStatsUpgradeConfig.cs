...
{
    [CreateAssetMenu(menuName = "Configs/Player Stats Upgrade Config", fileName = "PlayerStatsUpgradeConfig")]
    public class PlayerStatsUpgradeConfig : ScriptableObject
    {
        ...
        public StatUpgradeCostConfig GetStatConfig(StatTypes type) => _stats.First(stat => stat.Type == type);
        ...
        public class StatUpgradeCostConfig
        {
            ...
            [field: SerializeField] public CurrencyTypes CostType { get; private set; } = CurrencyTypes.Diamond;
